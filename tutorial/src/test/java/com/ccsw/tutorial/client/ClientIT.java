...
public class ClientIT {
    ...
    public void saveWithoutIdShouldCreateNewClient() {
        ...
        ClientDto clientDtoSearch = response.getBody().stream().filter(item -> item.getId().equals(NEW_CLIENT_ID)).findFirst().orElse(null);
        assertNotNull(clientDtoSearch);
    ...
    public void modifyWithExistIdShouldModifyClient() {
        ...
        ClientDto clientDtoSearch = response.getBody().stream().filter(item -> item.getId().equals(MODIFY_CLIENT_ID)).findFirst().orElse(null);
        assertNotNull(clientDtoSearch);
        assertEquals(NEW_CLIENT_NAME, clientDtoSearch.getName());
    }
